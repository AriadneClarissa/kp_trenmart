                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-4 text-center">
                                <div class="p-1 border rounded bg-light">
                                    <img id="preview_utama" src="{{ isset($produk->gambar) ? asset('storage/' . $produk->gambar) : asset('images/placeholder.png') }}" class="img-fluid rounded" style="height: 60px; width: 100%; object-fit: cover;">
                                    <div style="font-size: 0.6rem;" class="mt-1">Utama</div>
                                </div>
                            </div>
                            <div class="col-4 text-center">
                                <div class="p-1 border rounded bg-light">
                                    <img id="preview_2" src="{{ isset($produk->foto_2) ? asset('storage/' . $produk->foto_2) : asset('images/placeholder.png') }}" class="img-fluid rounded" style="height: 60px; width: 100%; object-fit: cover;">
                                    <div style="font-size: 0.6rem;" class="mt-1">Foto 2</div>
                                </div>
                            </div>
                            <div class="col-4 text-center">
                                <div class="p-1 border rounded bg-light">
                                    <img id="preview_3" src="{{ isset($produk->foto_3) ? asset('storage/' . $produk->foto_3) : asset('images/placeholder.png') }}" class="img-fluid rounded" style="height: 60px; width: 100%; object-fit: cover;">
