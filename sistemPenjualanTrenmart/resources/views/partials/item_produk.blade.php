<div class="col">
    <a href="{{ route('produk.detail', $item->kd_produk) }}" class="text-decoration-none">
        <div class="card h-100 border-0 shadow-sm p-3" style="border-radius: 20px; position: relative;">
            ...
            <div class="card-body p-0">
                ...
                <button class="btn w-100 py-2 d-flex align-items-center justify-content-center gap-2" 
                        ...
                        onclick="event.preventDefault(); window.location.href='{{ route('produk.detail', $item->kd_produk) }}'">
