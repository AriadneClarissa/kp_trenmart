                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <p class="small text-muted mt-2 mb-0">Jarak: <?php echo e($order->shipping_distance_km !== null ? number_format($order->shipping_distance_km, 2, ',', '.') . ' km' : '-'); ?> | Ongkir: Rp <?php echo e(number_format($order->shipping_cost ?? 0,0,',','.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
