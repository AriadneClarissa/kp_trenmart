...
<div class="container py-5 text-center">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <p class="text-muted">
                Terima kasih telah mendaftar, <strong><?php echo e($user->name); ?></strong>.<br>
            ...
            <div class="card bg-light border-0 rounded-3 mb-4 shadow-sm">
                <div class="card-body p-4 text-start">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold text-dark"><?php echo e($user->organization_name); ?></span>
                    </div>
                    ...
                    <hr class="my-2 opacity-25"> <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold text-dark"><?php echo e($user->phone_number); ?></span>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo LOQ\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views/auth/status_tinjau.blade.php ENDPATH**/ ?>