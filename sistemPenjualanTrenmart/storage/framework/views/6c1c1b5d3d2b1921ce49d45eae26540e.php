...
<body>
    ...
    <div class="judul-laporan">
        ...
        <span style="font-weight: normal; font-size: 12px;">
            Periode: <?php echo e(\Carbon\Carbon::parse(request('start', now()->startOfMonth()))->translatedFormat('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse(request('end', now()))->translatedFormat('d F Y')); ?>
...
</html><?php /**PATH C:\Users\Lenovo LOQ\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views/reports/print.blade.php ENDPATH**/ ?>