    ...
    <div class="card auth-card">
        <div class="card-body p-4 p-md-5">
            <div class="text-center mb-4">
                <img src="<?php echo e(asset('images/logotrenmart.png')); ?>" alt="Logo" style="height: 50px;">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Ariadne Clarissa" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="home_address" class="form-control" rows="2" placeholder="Jl. Nama Jalan No. 123, Kota..." required><?php echo e(old('home_address')); ?></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="customer_type" id="customer_type" class="form-select" onchange="toggleGrosirFields()" required>
                        <option value="regular" <?php echo e(old('customer_type') === 'regular' ? 'selected' : ''); ?>>Pelanggan Umum (Eceran)</option>
                        <option value="langganan" <?php echo e(old('customer_type') === 'langganan' ? 'selected' : ''); ?>>Pelanggan Grosir (Langganan)</option>
                    </select>
                </div>

                <div id="grosir_fields" style="display: <?php echo e(old('customer_type') === 'langganan' ? 'block' : 'none'); ?>;">
                    <div class="section-divider">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="organization_name" id="organization_name" class="form-control" value="<?php echo e(old('organization_name')); ?>" placeholder="Contoh: Toko Berkah Jaya">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="organization_type" id="organization_type" class="form-select">
                            ...
                            <option value="Toko/UMKM" <?php echo e(old('organization_type') === 'Toko/UMKM' ? 'selected' : ''); ?>>Toko / UMKM</option>
                            <option value="Perusahaan" <?php echo e(old('organization_type') === 'Perusahaan' ? 'selected' : ''); ?>>Perusahaan (PT/CV)</option>
                            <option value="Instansi" <?php echo e(old('organization_type') === 'Instansi' ? 'selected' : ''); ?>>Instansi Pemerintah</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="text-center mt-4">
                <p class="small text-muted">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-maroon fw-bold text-decoration-none">Masuk</a></p>
            </div>
        </div>
    </div>
</div>
...
</script><?php /**PATH C:\Users\Lenovo LOQ\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views/auth/register.blade.php ENDPATH**/ ?>