...
<div class="container mt-4 mb-5">
    <div class="row">
            ...
            <div class="sidebar-container">
                ...
                <div class="card-sidebar p-4">
                    ...
                    <div class="list-kategori" id="kategoriList">
                        <a href="<?php echo e(route('produk.index', ['search' => request('search'), 'merk' => request('merk')])); ?>" class="kat-item <?php echo e(!request('kategori') ? 'active' : ''); ?>">
                            Semua Produk <i class="bi bi-chevron-right small"></i>
                        </a>
                        <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('produk.index', ['kategori' => $kat->kd_kategori, 'search' => request('search'), 'merk' => request('merk')])); ?>" class="kat-item <?php echo e(request('kategori') == $kat->kd_kategori ? 'active' : ''); ?>">
                                <?php echo e($kat->nama_kategori); ?> <i class="bi bi-chevron-right small"></i>
                            </a>
        ...
        <div class="col-md-9">
            <form action="<?php echo e(route('produk.index')); ?>" method="GET" class="row g-3 mb-4 align-items-center">
                <div class="col-md-6">
            ...
            <div class="row row-cols-2 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card card-produk p-3" style="cursor: pointer;" onclick="window.location.href='<?php echo e(route('produk.detail', ['id' => $p->kd_produk, 'from' => 'produk.index'])); ?>'">
                        <div class="img-container mb-3">
                            ...
                            <?php endif; ?>
                            <img src="<?php echo e(asset('storage/' . $p->gambar)); ?>" class="img-fluid" style="height: 140px; object-fit: contain;">
                        </div>
                        <div class="product-info text-center">
                            <p class="text-muted small mb-1"><?php echo e($p->merk->nama_merk ?? 'Tanpa Merk'); ?></p>
                            <h6 class="fw-bold text-dark text-truncate mb-2"><?php echo e($p->nama_produk); ?></h6>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo LOQ\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views/admin/edit_katalog.blade.php ENDPATH**/ ?>