    ...
    <div class="auth-card p-5"> 
        ...
        <form action="<?php echo e(route('admin.login')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control-custom" placeholder="admin@trenmart.com" value="<?php echo e(old('email')); ?>" required>
            </div>
        ...
        <div class="text-center mt-2">
            <a href="<?php echo e(route('beranda')); ?>" class="text-decoration-none small text-secondary">← Kembali ke Toko</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo LOQ\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views/auth/login_admin.blade.php ENDPATH**/ ?>